...
from ...models.penalty_forever_post_body import PenaltyForeverPostBody
...
def _get_kwargs(
    floor_id: int,
    *,
    body: PenaltyForeverPostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/penalty/{floor_id}/_forever",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Ban publisher of a floor forever
