...
from ...models.floor_modify_model import FloorModifyModel
...
def _get_kwargs(
    id: int,
    *,
    body: FloorModifyModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/floors/{id}/_webvpn",
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Modify A Floor
     ...
     when both \"fold_v2\" and \"fold\" are empty, reset fold; else, \"fold_v2\" has the priority
