...
T = TypeVar("T", bound="FloorCreateOldModel")


@_attrs_define
class FloorCreateOldModel:
    """
    Attributes:
        content (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        floor_create_old_model.additional_properties = d
        return floor_create_old_model
